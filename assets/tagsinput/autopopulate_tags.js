...
$(document).on('change', '#blog_cat', function (e) {

    var jsonData = [];

    var blog_cat = $('#blog_cat').val();

    var url = 'http://localhost/sheacreams/website/Ajax_Function/get_tags';
    ...
    $.ajax({
        ...
        success:function(data)
        {
            ...
            $('#first_div').html('<input id="ms1" class="form-control" type="text" name="tags"/>');
