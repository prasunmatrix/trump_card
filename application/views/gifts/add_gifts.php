            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="custom-validation" action="<?php echo site_url(); ?>Gifts/addgifts" method="post" autocomplete="off">
                            ...
                            <div class="form-group mb-0">
                              <div>
                                ...
                                <input type="submit" name="addgifts" id="addgifts" class="btn btn-success waves-effect waves-light mr-1" value="Add Details">
                              </div>
                            </div>
                        </form>
...
jQuery(function(){
  ...
  jQuery('#add_more').click(function(event){
    ...
    var newRow = jQuery('<div id="'+session_id+'"><div class="form-group"><label>Gift / Voucher Name</label><input type="text" class="form-control" required name="gift_name[]" id="gift_name'+session_id+'" placeholder="Gift / Voucher name"/></div><div class="form-group"><label>Gift / Voucher Value</label><input type="number" class="form-control" required name="gift_value[]" id="gift_value'+session_id+'" placeholder="Gift / Voucher Value"/></div><div class="form-group"><label>Coins Redeem Value</label><input type="number" class="form-control" required name="coins_redeem_value[]" id="coins_redeem_value'+session_id+'" placeholder="Coins Redeem Value"/></div><div align="left"><a href="javascript:void(0)" class="btn btn-danger waves-effect" onclick="remove(this);" data-sessionid="'+session_id+'">Remove</a></div></div>');
