        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title-box">
                    <h4 class="font-size-18">Add Cardtype</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="custom-validation" method="post" action="<?php echo site_url(); ?>Cardtype/addcardtype" autocomplete="off">
                            ...
                            <div class="cardtype_list">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" required="required"  name="card_type[]" id="card_type" placeholder="Card Type"/>
                              </div>  
                              <!-- <div class="form-group">
                                <label>Status</label>
                            ...
                            <div class="form-group mb-0">
                                <div>
                                    <input type="submit" class="btn btn-success waves-effect waves-light mr-1" name="addcardtype" id="addcardtype" value="Add Details">
...
jQuery(function(){
    ...
    jQuery('#add_more').click(function(event){
      ...
      var newRow = jQuery('<div id="'+session_id+'"><div class="form-group"><label>Card Type</label><input type="text" class="form-control" required="required" name="card_type[]" id="card_type'+counter+'" placeholder="Card Type"/></div><div align="left"><a href="javascript:void(0)" class="btn btn-danger waves-effect" onclick="remove(this);" data-sessionid="'+session_id+'">Remove</a></div></div>');
