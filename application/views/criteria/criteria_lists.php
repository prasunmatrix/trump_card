        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title-box">
                    <h4 class="font-size-18">Criteria & Points Lists</h4>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="<?=base_url()?>"><i class="fa fa-home"></i> Home</a></li>
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Master Data</a></li>
                        <li class="breadcrumb-item active">Criteria & Points Lists</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="float-right d-none d-md-block mr-2">
                    <a href="<?=base_url()?>Criteria/add_criteria"><button type="button" class="btn btn-success waves-effect waves-light">Add Criteria</button></a>
                </div>
            </div>
