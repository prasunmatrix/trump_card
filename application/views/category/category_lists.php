        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title-box">
                    <h4 class="font-size-18">Category Lists</h4>
                              ...
                              <?php 
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td><img src="<?php echo base_url()?>assets/uploads/category/<?php echo $value['category_banner_image'] ?>" style="width:90px;height:60px;" /></td>
                                    <!-- <td><?php echo  $value['meta_keyword']; ?></td>
                                    <td><?php echo  $value['meta_description']; ?></td> -->
                                    <td>
                                      <?php if($value['status']==1){ ?>
                                      <a href="<?php echo base_url();?>Category/statuschange/<?php echo $value['categoryid']; ?>" onclick="return statusChange();"><button type="button" class="btn btn-success waves-effect waves-light">Active</button></a>
                                      <?php }else{ ?>  
                                      <a href="<?php echo base_url();?>Category/statuschange/<?php echo $value['categoryid']; ?>" onclick="return statusChange();"><button type="button" class="btn btn-danger waves-effect waves-light">Inactive</button></a>
                                      <?php } ?>
                                    </td>
                                    <td>
                                      <!-- <button type="button" class="btn btn-success waves-effect waves-light">View</button> -->
                                      <a href="<?php echo base_url();?>Category/editcategory/<?php echo $value['categoryid']; ?>"><button type="button" class="btn btn-primary waves-effect waves-light">Update</button></a>
                                    </td>                                
                                  </tr>
                                <?php
                                  $count++;
