            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="custom-validation" method="post" action="<?php echo site_url(); ?>Category/addcategory" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form-group">
                              ...
                              <input type="file" class="filestyle" required name="category_banner_image" id="category_banner_image" placeholder="Category Banner Image"/>
                            ...
                            <div class="form-group mb-0">
                                <div>
                                  ...
                                  <input type="submit" class="btn btn-success waves-effect waves-light mr-1" name="addcategory" value="Add Details">
