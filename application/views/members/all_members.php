          ...
          <div class="col-8">
              <div class="card">
                  <div class="card-body" style="padding-bottom: 20px;">                       
                      <div class="row">
                        <div class="col-md-5">
                          <input type="text" id="from_date" placeholder="From Date" class="form-control date" name="from_date" autocomplete="off">
                        </div>
                        <div class="col-md-5">
                          <input type="text" id="to_date" placeholder="To Date" class="form-control date" name="to_date" autocomplete="off">
                        </div>
                        <div class="col-md-2">
                        ...
                        <table id="datatable" class="table table-bordered table-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody id="Ajax_View">
                              ...
                              <tr>
                                  ...
                                  <td><a href="<?php echo base_url();?>Members/viewparticularmember/<?php echo $value['id']; ?>"><button type="button" class="btn btn-success waves-effect waves-light">View</button></a></td>
                                  <td>
                                    <?php if($value['status']==1){ ?>
                                    <a href="<?php echo base_url();?>Members/statuschange/<?php echo $value['id']; ?>" onclick="return statusChange();"><button type="button" class="btn btn-success waves-effect waves-light">Active</button></a>
                                    <?php }else{ ?>  
                                    <a href="<?php echo base_url();?>Members/statuschange/<?php echo $value['id']; ?>" onclick="return statusChange();"><button type="button" class="btn btn-danger waves-effect waves-light">Inactive</button></a>
                                    <?php } ?>
                                  </td>
                              </tr>
                              <?php $count++;} ?>                                   
