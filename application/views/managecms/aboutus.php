                    ...
                    <div class="card-body">
                        <form class="custom-validation" action="#">
                            <div class="form-group">
                              ...
                              <input type="file" class="filestyle" required name="" id="" placeholder="About Us Image"/>
                              <p class="note">NOTE : Image size maximum 2MB and dimentions ( 100 X 100 ) PX</p>
                            </div>
                            <div class="form-group">
                              <label>About Us Description</label>
                              <textarea name="" id="elm1" class="form-control" required placeholder="Meta Description"></textarea>
                            </div>  
                            <!-- <div class="form-group">
                              <label>Status</label>
