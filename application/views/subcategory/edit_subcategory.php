        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title-box">
                    <h4 class="font-size-18">Edit Subcategory</h4>
            ...
            <div class="col-sm-6">
                ...
                <div class="float-right d-none d-md-block mr-2">
                    <a href="<?=base_url()?>Subcategory"><button type="button" class="btn btn-success waves-effect waves-light">Subcategory Lists</button></a>
                </div>
            </div>
        </div>     
                        ...
                        <form class="custom-validation" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                            <div class="form-group">
                              ...
                              <select required class="form-control" name="category_id" id="category_id">
                                ...
                                ?>
                                <option value="<?php echo $value['categoryid']; ?>"<?php if($editsubcategory_data->category_id==$value['categoryid']){?> selected="selected" <?php } ?> ><?php echo $value['category_name']; ?></option>
                                <?php
                                    }
                                  }
                                ?>
                            ...
                            <div class="subcategory_list">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="subcategory_name" id="subcategory_name" placeholder="Sub Category Name" value="<?php echo $editsubcategory_data->subcategory_name; ?>" />
                              </div>
                              <div class="form-group">
                                <label>Sub Category Banner Image</label><br/>
                                <img src="<?php echo base_url()?>assets/uploads/subcategory/<?php echo $editsubcategory_data->subcategory_banner_image; ?>" style="width:90px;height:60px;" /><br/><br/>
                                <input type="file" class="filestyle" name="sub_category_banner_image" id="sub_category_banner_image" placeholder="Sub Category Banner Image"/>
                                <p class="note">NOTE : Image size maximum 2MB and dimentions ( 100 X 100 ) PX</p>
                                <input type="hidden" name="subcategory_old_image" id="subcategory_old_image" value="<?php echo $editsubcategory_data->subcategory_banner_image; ?>" />
                              </div>
                              <div class="form-group">
                                <label>Meta Keyword</label>
                                <input type="text" class="form-control"  name="meta_keyword" id="meta_keyword" value="<?php echo $editsubcategory_data->meta_keyword; ?>" placeholder="Meta Keyword"/>
                              </div>
                              <div class="form-group">
                                <label>Meta Description</label>
                                <textarea name="meta_description" id="meta_description" class="form-control" placeholder="Meta Description"><?php echo $editsubcategory_data->meta_description; ?></textarea>
                              </div>  
                              <!-- <div class="form-group">
                            ...
                            <div class="form-group mb-0">
                                <div>
                                    <input type="hidden" name="edit_id" id="edit_id" value="<?php echo $editsubcategory_data->subcategoryid; ?>" />
                                    <input type="submit" class="btn btn-success waves-effect waves-light mr-1" name="editsubcategory" id="editsubcategory" value="Update Details">
