                        ...
                        <form class="custom-validation" method="post" action="<?php echo site_url(); ?>Subcategory/addsubcategory" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="subcategory_list">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="subcategory_name[]" id="subcategory_name" placeholder="Subcategory Name"/>
                              </div>
                              <div class="form-group">
...
jQuery(function(){
    ...
    jQuery('#add_more').click(function(event){
      ...
      var newRow = jQuery('<div id="'+session_id+'"><div class="form-group"><label>Subcategory Name</label><input type="text" class="form-control" required name="subcategory_name[]" id="subcategory_name'+session_id+'" placeholder="Subcategory Name"/></div><div class="form-group"><label>Subcategory Banner Image</label><input type="file" class="filestyle" required  name="sub_category_banner_image[]" id="sub_category_banner_image'+session_id+'" placeholder="Subcategory Banner Image"/><p class="note">NOTE : Image size maximum 2MB and dimentions ( 100 X 100 ) PX</p></div><div class="form-group"><label>Meta Keyword</label><input type="text" class="form-control" name="meta_keyword[]" id="meta_keyword'+session_id+'" placeholder="Meta Keyword"/></div><div class="form-group"><label>Meta Description</label><textarea name="meta_description[]" id="meta_description'+session_id+'" class="form-control"  placeholder="Meta Description"></textarea></div><div align="left"><a href="javascript:void(0)" class="btn btn-danger waves-effect" onclick="remove(this);" data-sessionid="'+session_id+'">Remove</a></div><br/></div>');
