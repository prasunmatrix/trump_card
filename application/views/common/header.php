...
<html lang="en">
    ...
    <head>
        ...
        <!------------------For tags input  date: 16/Sep/2020----------->
        <link href="<?=base_url()?>assets/tagsinput/tagsinput.css" rel="stylesheet" type="text/css" />
        <link href="<?=base_url()?>assets/tagsinput/autopopulate_tags.css" rel="stylesheet" type="text/css" />
        <!------------------For tags input  date: 16/Sep/2020----------->
    </head>
