...
class Attribute extends MY_Controller 
{
  ...
  public function editattribute($id){
    ...
    if($this->input->post('editattribute'))
    {
      ...
      $edit_attribute_data=array('category_id'=>$categoryId,'subcategory_id'=>$subcategoryId,'card_type_id'=>$cardtype_id,'attribute_name'=>$attribute_name,'attribute_value'=>$attribute_value,'attribute_win'=>$attribute_win,'point_assigned'=>$point_assigned);
